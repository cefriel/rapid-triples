<template>
  <div>
    ...
    <v-row class="px-10 my-2">
      <v-col cols="8" class="py-2">
        <p>
          ...
          compliant with the minimum profile required by mobilityDCAT-AP.<br /><br />
          The page is client-side only so all the information inserted are not
          collected/stored but can not be retrieved if the page is reloaded. The
          output RDF can be converted to different serializations using online
          converters such as <a href="https://rdfshape.weso.es/dataConvert">RDFShape</a>.<br /><br />
          This page is powered by <b>KCONG (Knowledge Catalogue and
          Governance)</b> a complete (meta)data catalogue solution developed by
          <a href="https://www.cefriel.com/">Cefriel</a>. If you want to know
          more visit <a href="https://kcong.cefriel.com/">https://kcong.cefriel.com/</a>.
        </p>
      </v-col>
    ...
    <Alert v-for="(alert_message, index) in alert_messages" :key="index" :message="alert_message.message" :alert_type="alert_message.alert_type" />
    <v-container>
      <v-row>
        <v-col cols="6">
        ...
        <v-col cols="6">
          ...
          <div v-else class="text-center">
            <img src="@/assets/no_data.png" alt="No Data Available" style="max-width: 60%; height: auto; margin-top: 200px;" />
  ...
  methods: {
    ...
    create_object() {
      ...
      function slugify(str) {
        return String(str)
            .normalize('NFKD') // split accented characters into their base characters and diacritical
